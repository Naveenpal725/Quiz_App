...
class MainActivity : AppCompatActivity() {
    ...
    private val questions = arrayListOf("Identify tense: \"Will you be in Bangkok tomorrow?\"","Select the word which begins with a consonant.","Which word has a short /e/ sound?","Which word has a short /a/ sound?","Which word has a short /i/ sound?")
    private val options1 = arrayListOf("Future perfect","Future continuous","Future simple","None of the Above")
    ...
    private val answers = arrayListOf("Future simple","Oven","Bed","Cap","Hit")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.myToggleGroup.addOnButtonCheckedListener { _, checkedId, isChecked ->
            if (isChecked) {
